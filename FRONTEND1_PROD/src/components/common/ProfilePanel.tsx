...
const primaryActions: Item[] = [
  { label: 'View Profile', path: '/personal-details', icon: 'user' },
  { label: 'Edit CV', path: '/uploadcv', icon: 'edit' },
...
const secondaryActions: Item[] = [
  ...
  { label: 'Saved Jobs', path: '/saved-jobs', icon: 'saved' },
  { label: 'LMS', path: '/lms', icon: 'lms' },
];

const systemActions: Item[] = [
  { label: 'Notification Preferences', path: '/notification-preferences', icon: 'notifications' },
