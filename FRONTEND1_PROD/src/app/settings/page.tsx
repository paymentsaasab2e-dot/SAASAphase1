      ...
      <ProfileDrawer
        ...
        footer={(
          <div className="flex justify-end gap-3">
            ...
            <button onClick={() => setIsAccountOpen(false)} className="h-10 px-5 rounded-lg bg-orange-500 text-sm font-medium text-white hover:bg-orange-600">Save Changes</button>
          </div>
        )}
      >
      ...
      <ProfileDrawer
        ...
        footer={(
          <div className="flex justify-end gap-3">
            ...
            <button onClick={() => setIsNotificationsOpen(false)} className="h-10 px-5 rounded-lg bg-orange-500 text-sm font-medium text-white hover:bg-orange-600">Save Changes</button>
          </div>
        )}
      >
      ...
      <ProfileDrawer
        ...
        footer={(
          <div className="flex justify-end gap-3">
            ...
            <button onClick={() => setIsPrivacyOpen(false)} className="h-10 px-5 rounded-lg bg-orange-500 text-sm font-medium text-white hover:bg-orange-600">Save Changes</button>
          </div>
        )}
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <ProfileDrawer
        ...
        footer={(
          <div className="flex justify-end gap-3">
            ...
            <button onClick={() => setIsPreferencesOpen(false)} className="h-10 px-5 rounded-lg bg-orange-500 text-sm font-medium text-white hover:bg-orange-600">Save Changes</button>
          </div>
        )}
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <ProfileDrawer
        ...
        footer={(
          <div className="flex justify-end gap-3">
            ...
            <button onClick={() => setIsApplicationOpen(false)} className="h-10 px-5 rounded-lg bg-orange-500 text-sm font-medium text-white hover:bg-orange-600">Save Changes</button>
          </div>
        )}
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
